...
export const footerMessages = {
  copyrightText: "© 2024 YapPad. All rights reserved.",
};
...
export const resetPasswordPageMessages = {
  ...
  resetPasswordError: "Something went wrong!",
  resetButton: "Reset",
};

export const signupPageMessages = {
  signupHeading: "Sign Up",
  emailLabel: "Email (will be used for Login)",
...
export const yapDetailPageMessages = {
  backToYappingChamberButton: "Back to Yapping Chamber",
  loadingYapMessage: "Loading yap...",
};
